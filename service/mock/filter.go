...
// Ensure, that FilterStoreMock does implement service.FilterStore.
// If this is not the case, regenerate this file with moq.
var _ service.FilterStore = &FilterStoreMock{}
...
func (mock *FilterStoreMock) Checker(contextMoqParam context.Context, checkState *healthcheck.CheckState) error {
	if mock.CheckerFunc == nil {
		panic("FilterStoreMock.CheckerFunc: method is nil but FilterStore.Checker was just called")
	}
	callInfo := struct {
		ContextMoqParam context.Context
		CheckState      *healthcheck.CheckState
