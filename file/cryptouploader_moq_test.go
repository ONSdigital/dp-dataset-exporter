...
// Ensure, that CryptoUploaderMock does implement CryptoUploader.
// If this is not the case, regenerate this file with moq.
var _ CryptoUploader = &CryptoUploaderMock{}
...
//         }
//
//         // use mockedCryptoUploader in code that requires CryptoUploader
...
func (mock *CryptoUploaderMock) UploadWithPSK(input *s3manager.UploadInput, psk []byte) (*s3manager.UploadOutput, error) {
	if mock.UploadWithPSKFunc == nil {
		panic("CryptoUploaderMock.UploadWithPSKFunc: method is nil but CryptoUploader.UploadWithPSK was just called")
	}
	callInfo := struct {
		Input *s3manager.UploadInput
		Psk   []byte
